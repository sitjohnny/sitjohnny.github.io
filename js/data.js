export const STOPS = [
  {
    ...
    name: "Pecoshitas",
    category: "latino",
    address: "80-03 Roosevelt Ave, Jackson Heights, NY",
    ...
    crawlMove:
      "Share a cheese bread or pastry. Save cake-heavy items if you want room for dessert later.",
    tags: [
      "colombian",
      "bakery",
      "cafe",
  ...
  },
  {
    ...
    address: "37-61 80th St, Jackson Heights, NY",
    ...
    crawlMove:
      "Good early caffeine stop. Split one onigiri or sandwich if you are pacing the crawl.",
    tags: [
      "japanese",
      "coffee",
      "matcha",
  ...
  },
  {
    ...
    name: "Birria-Landia",
    category: "latino",
    address: "77-05 Roosevelt Ave, Jackson Heights, NY",
    ...
    crawlMove:
      "Order tacos plus consome for dipping. One taco per person is a good pace.",
    tags: [
      "birria",
      "tacos",
      "consome",
  ...
  },
  {
    ...
    name: "Arepa Lady",
    category: "latino",
    address: "77-17 37th Ave, Jackson Heights, NY",
    ...
    crawlMove:
      "Split one arepa or a small plate. Avoid full platters unless this becomes a sit-down break.",
    tags: [
      "arepa",
      "colombian",
      "venezuelan",
  ...
  },
  {
    ...
    category: "himalayan",
    address: "76-03 37th Ave, Jackson Heights, NY",
    menuUrl:
    ...
    crawlMove:
      "Try momos or a noodle dish. Keep the order small — many Himalayan stops are nearby.",
    tags: [
      "tibetan",
      "momo",
      "chowmein",
  ...
  {
    id: "laliguras-restaurant",
    name: "Laliguras Restaurant",
    category: "himalayan",
    address: "37-63 76th St, Jackson Heights, NY",
    menuUrl:
    ...
    crawlMove:
      "Good for a momo/chowmein comparison or a shared thali if the group wants a sit-down stop.",
    tags: [
      "nepalese",
      "thali",
      "momo",
  ...
  {
    id: "nepali-bhanchha-ghar",
    name: "Nepali Bhanchha Ghar",
    category: "himalayan",
    address: "74-15 Roosevelt Ave, Jackson Heights, NY",
    ...
    crawlMove:
      "A strong momo stop. Order one momo style for the table instead of doubling up at every Himalayan spot.",
    tags: [
      "nepalese",
      "momo",
      "jhol momo",
  ...
  },
  {
    ...
    name: "Phayul",
    category: "himalayan",
    address: "37-65 74th St, Jackson Heights, NY",
    ...
    crawlMove:
      "Good for Tibetan dumplings or one spicy shared dish if you want contrast from the Nepali stops.",
    tags: [
      "tibetan",
      "momo",
      "fried momo",
  ...
  },
  {
    ...
    category: "indian-bengali",
    address: "73-10 37th Ave, Jackson Heights, NY",
    menuUrl:
    ...
    crawlMove:
      "Use this as a light sweet/savory snack stop, not the final dessert since Filipino dessert is planned last.",
    tags: [
      "indian",
      "sweets",
      "samosa",
  ...
  },
  {
    ...
    name: "Fuskahouse NYC",
    category: "indian-bengali",
    address: "73-01 37th Ave, Jackson Heights, NY",
    ...
    crawlMove:
      "Ideal shared stop: order fuska/pani puri for the group and keep it moving.",
    tags: [
      "bengali",
      "fuska",
      "pani puri",
  ...
  },
  {
    ...
    name: "Aama's Kitchen",
    category: "himalayan",
    address: "72-19 Roosevelt Ave, Jackson Heights, NY",
    menuUrl:
    ...
    crawlMove:
      "Chicken or veg thali is best for a meal. For a crawl, split momos or chowmein.",
    tags: [
      "nepalese",
      "thali",
      "momo",
  ...
  },
  {
    ...
    name: "Ihawan",
    category: "filipino",
    address: "40-06 70th St, Woodside, NY",
    ...
    crawlMove:
      "Share pork BBQ skewers or one BBQ meal. This is the savory Filipino anchor before desserts.",
    tags: [
      "filipino",
      "bbq",
      "pork",
  ...
  },
  {
    ...
    name: "Ngatso Cafe",
    category: "coffee-cafe",
    address: "39-08 63rd St, Woodside, NY",
    ...
    crawlMove:
      "Good second caffeine/rest stop. Order a drink and one small snack if needed.",
    tags: [
      "tibetan",
      "coffee",
      "matcha",
  ...
  },
  {
    id: "peking-bbq",
    name: "Peking BBQ",
    category: "chinese-peruvian",
    address: "58-11 Woodside Ave, Woodside, NY",
    ...
    crawlMove:
      "Split a quarter or half chicken with sides. Best as a savory shared plate.",
    tags: [
      "chinese",
      "peruvian",
      "chifa",
  ...
  },
  {
    ...
    name: "The Weekender",
    category: "himalayan",
    address: "41-46 54th St, Woodside, NY",
    ...
    crawlMove:
      "Try ezay, momos, or a small Bhutanese dish if the group still has savory room.",
    tags: [
      "bhutanese",
      "himalayan",
      "momo",
  ...
  {
    id: "red-ribbon-bakeshop",
    name: "Red Ribbon Bakeshop",
    category: "desserts",
    address: "65-02 Roosevelt Ave, Woodside, NY",
    menuUrl:
    ...
    crawlMove:
      "Dessert finale stop 1: cake slices or one halo-halo-style dessert to share.",
    tags: [
      "filipino",
      "dessert",
      "ube",
  ...
  },
  {
    ...
    name: "Purple Dough",
    category: "desserts",
    address: "63-04 39th Ave, Woodside, NY",
    ...
    crawlMove:
      "Dessert finale stop 2: ube leche flan, mini cupcakes, cake donuts, or halo-halo.",
    tags: [
      "filipino",
      "dessert",
      "ube",
